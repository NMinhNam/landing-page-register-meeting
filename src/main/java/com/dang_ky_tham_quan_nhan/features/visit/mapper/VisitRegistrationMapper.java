...
public interface VisitRegistrationMapper {
    ...
    @Select("<script>" +
            ...
            ") " +
            "SELECT v.id, v.soldier_id, v.unit_id, v.manual_soldier_name, v.manual_unit_name, v.representative_phone, v.province, v.visit_week, v.visit_week_month_display, v.visit_year, v.visit_month, v.status, v.note, v.created_at, v.approved_at, v.unit_id, " +
            "COALESCE(s.name, v.manual_soldier_name) as soldier_name, " +
